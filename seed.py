...
PRODUCTS = [
    # ── Bakeware (18) ──────────────────────────────────────────────────────────
    ("Non-Stick Loaf Pan", "non-stick-loaf-pan", "Perfect for sourdough and banana bread.", 12.99, 80, "bakeware", "/assets/products/non-stick-loaf-pan.jpg"),
    ("Round Cake Tin 8-inch", "round-cake-tin-8inch", "Classic round tin for layer cakes.", 9.99, 120, "bakeware", "/assets/products/round-cake-tin-8inch.jpg"),
    ("Muffin Tray 12-Cup", "muffin-tray-12cup", "Heavy-gauge steel, non-stick coating.", 14.49, 95, "bakeware", "/assets/products/muffin-tray-12cup.jpg"),
    ("Square Brownie Pan", "square-brownie-pan", "Even heat distribution for fudgy brownies.", 11.99, 70, "bakeware", "/assets/products/square-brownie-pan.jpeg"),
    ("Springform Pan 9-inch", "springform-pan-9inch", "Easy release for cheesecakes and tarts.", 15.99, 60, "bakeware", "/assets/products/springform-pan-9inch.jpg"),
    ("Bundt Pan Classic", "bundt-pan-classic", "Intricate pattern for stunning ring cakes.", 18.99, 45, "bakeware", "/assets/products/bundt-pan-classic.jpg"),
    ("Sheet Pan Half-Size", "sheet-pan-half-size", "Commercial-grade aluminium baking sheet.", 10.99, 150, "bakeware", "/assets/products/sheet-pan-half-size.jpeg"),
    ("Mini Loaf Pan Set x4", "mini-loaf-pan-set", "Four mini loaf tins in one set.", 16.99, 55, "bakeware", "/assets/products/mini-loaf-pan-set.jpeg"),
    ("Tart Pan with Removable Base", "tart-pan-removable-base", "11-inch fluted tart tin.", 13.49, 65, "bakeware", None),
    ("Silicone Muffin Mould", "silicone-muffin-mould", "Flexible silicone — no greasing needed.", 8.99, 110, "bakeware", "/assets/products/silicone-muffin-mould.jpeg"),
    ("Pizza Stone", "pizza-stone", "Crispy crusts every time.", 24.99, 40, "bakeware", "/assets/products/pizza-stone.jpeg"),
    ...
    ("Pullman Loaf Pan with Lid", "pullman-loaf-pan-lid", "Produces perfectly square sandwich loaves.", 22.99, 50, "bakeware", "/assets/products/pullman-loaf-pan-lid.jpeg"),
    ("Ceramic Pie Dish", "ceramic-pie-dish", "Deep dish for generous fruit pies.", 17.49, 55, "bakeware", "/assets/products/ceramic-pie-dish.jpeg"),
    ("Angel Food Cake Pan", "angel-food-cake-pan", "Tall centre tube for light sponge cakes.", 14.99, 42, "bakeware", "/assets/products/angel-food-cake-pan.jpeg"),
    ("Ramekins Set of 6", "ramekins-set-6", "Oven-safe ramekins for soufflés and crème brûlée.", 19.99, 70, "bakeware", "/assets/products/ramekins-set-6.jpeg"),
    ("Madeline Pan", "madeline-pan", "Classic shell-shaped French madeleine mould.", 12.49, 60, "bakeware", "/assets/products/madeline-pan.jpeg"),

    # ── Ingredients (18) ──────────────────────────────────────────────────────
    ("Strong White Bread Flour 1kg", "strong-white-bread-flour-1kg", "High-protein flour ideal for yeast breads.", 3.49, 200, "ingredients", "/assets/products/strong-white-bread-flour-1kg.jpeg"),
    ("Self-Raising Flour 1.5kg", "self-raising-flour-1-5kg", "Pre-mixed with raising agents.", 3.29, 180, "ingredients", "/assets/products/self-raising-flour-1-5kg.jpg"),
    ...
    ("Cocoa Powder 250g", "cocoa-powder-250g", "Dutch-processed, intense chocolate flavour.", 3.99, 140, "ingredients", "/assets/products/cocoa-powder-250g.jpeg"),
    ("Vanilla Bean Paste 100ml", "vanilla-bean-paste-100ml", "Real vanilla seeds in a convenient paste.", 6.99, 90, "ingredients", "/assets/products/vanilla-bean-paste-100ml.jpeg"),
    ("Active Dry Yeast 100g", "active-dry-yeast-100g", "Reliable leavening for breads and rolls.", 3.49, 130, "ingredients", "/assets/products/active-dry-yeast-100g.jpeg"),
    ...
    ("Almond Flour 500g", "almond-flour-500g", "Blanched and finely ground for macarons.", 7.99, 80, "ingredients", "/assets/products/almond-flour-500g.jpeg"),
    ("Dark Chocolate Chips 300g", "dark-chocolate-chips-300g", "70% cocoa, perfect for cookies and muffins.", 4.49, 170, "ingredients", "/assets/products/dark-chocolate-chips-300g.jpg"),
    ...
    ("Piping Bag Set 20pcs", "piping-bag-set-20pcs", "Disposable bags with 10 nozzle tips.", 9.99, 130, "decorating-tools", "/assets/products/piping-bag-set-20pcs.jpg"),
    ("Turntable Cake Stand", "turntable-cake-stand", "Smooth 360° rotating stand.", 19.99, 60, "decorating-tools", "/assets/products/turntable-cake-stand.jpg"),
    ("Bench Scraper Stainless", "bench-scraper-stainless", "Sharp edge for perfectly smooth sides.", 5.99, 90, "decorating-tools", None),
    ("Fondant Smoother", "fondant-smoother", "Dual-sided paddle for flawless fondant.", 6.49, 75, "decorating-tools", "/assets/products/fondant-smoother.jpg"),
    ("Cookie Cutter Set 20pcs", "cookie-cutter-set-20pcs", "Stainless steel seasonal shapes.", 12.99, 85, "decorating-tools", "/assets/products/cookie-cutter-set-20pcs.jpg"),
    ...
    ("Food Colouring Gel Set 12", "food-colouring-gel-set-12", "Vibrant, concentrated gel colours.", 15.99, 80, "decorating-tools", "/assets/products/food-colouring-gel-set-12.jpg"),
    ("Edible Gold Dust 5g", "edible-gold-dust-5g", "FDA-approved shimmer for luxury finishes.", 4.99, 60, "decorating-tools", None),
    ("Cake Decorating Comb Set", "cake-decorating-comb-set", "Textured combs for stripe patterns.", 7.99, 55, "decorating-tools", "/assets/products/cake-decorating-comb-set.jpeg"),
    ("Palette Knife Straight", "palette-knife-straight", "Flexible steel for spreading and lifting.", 5.49, 100, "decorating-tools", None),
    ("Silicone Mould Roses", "silicone-mould-roses", "Detailed rose cavity mould for fondant.", 6.99, 70, "decorating-tools", "/assets/products/silicone-mould-roses.jpeg"),
    ...
    # ── Accessories (16) ─────────────────────────────────────────────────────
    ("Baker's Apron Canvas", "bakers-apron-canvas", "Cross-back, heavy-duty canvas apron.", 24.99, 70, "accessories", "/assets/products/bakers-apron-canvas.jpg"),
