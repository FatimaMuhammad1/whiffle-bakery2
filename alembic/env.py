...
- Uses `run_async_migrations()` to support asyncpg.
- DATABASE_URL is pulled from app.config (reads .env automatically).
"""
import asyncio
...
async def run_async_migrations() -> None:
    ...
    connectable = async_engine_from_config(
        ...
        prefix="sqlalchemy.",
        poolclass=pool.NullPool,  # use NullPool during migrations
    )
